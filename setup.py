...
setup(
    ...
    packages=['MacAutoSymbolizer',
              ...
              'MacAutoSymbolizer.tools.libMap',
              'MacAutoSymbolizer.tools.scanner',
              'MacAutoSymbolizer.tools.symbolize',
              'MacAutoSymbolizer.tools.downloader',
              'MacAutoSymbolizer.mac_symbolize'],
